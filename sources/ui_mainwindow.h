...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        labelMS->setGeometry(QRect(695, 370, 16, 16));
        QFont font1;
...
"QRadioButton::indicator{width:25px;height:25px;border-radius:12px;}"));
        ...
        comboBoxComBaud->setGeometry(QRect(70, 60, 91, 23));
        ...
        checkBoxAutoDownload->setGeometry(QRect(70, 125, 101, 16));
        ...
        pushButtonSaveRev->setGeometry(QRect(70, 30, 91, 23));
        ...
        TextRev->setGeometry(QRect(10, 20, 321, 331));
